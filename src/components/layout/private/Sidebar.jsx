...
export const Sidebar = () => {
    ...
    const savePublication = async (e) => {
        ...
        let newPunlication = form;
        newPunlication.user = auth._id;

        //Hacer request para guardad en ldb
        const request = await fetch(Global.url + "publication/save", {
            method: "POST",
            body: JSON.stringify(newPunlication),
            headers: {
        ...
        //Mostrar Mensjae de existo o error
